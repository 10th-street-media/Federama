 ...
 */
	$atommeta = fopen("users/".$username."-atom.xml", "w") or die("Unable to open or create users/".$username."-atom.xml file");
 ...
 */
	...
	$rss2meta = fopen("users/".$username."-rss2.xml", "w") or die("Unable to open or create users/".$username."-rss2.xml file");
