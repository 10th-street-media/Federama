                ...
                <form method="POST" action="<?php echo htmlspecialchars($website_url."dash/profile.php"); ?>">
                    ...
                    <table class="w3-table w3-margin-left">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="user-name" id="user-name" role="textbox" aria-multiline="false" class="w3-input w3-border w3-margin-bottom" required maxlength="20" value="<?php echo $u_name; ?>" title="<?php echo _('Usernames cannot be changed.'); ?>" disabled tabindex="1"></td>
                        </tr>
                        <tr>
                            <td><?php echo _("Display name"); ?></td>
                            <td><input type="text" name="user-dname" id="user-dname" role="textbox" aria-multiline="false" class="w3-input w3-border w3-margin-bottom" maxlength="255" value="<?php echo $u_dname; ?>" title="<?php echo _('The name that will be displayed.'); ?>" tabindex="2"></td>
                        </tr>
                        <tr>
                            <td><?php echo _("Email address"); ?></td>
                            <td><input type="email" name="user-email" id="user-email" role="textbox" aria-multiline="false" class="w3-input w3-border w3-margin-bottom" maxlength="255" value="<?php echo $u_email; ?>" title="<?php echo _('Your email address.'); ?>" tabindex="3"></td>
                        </tr>
                        <tr>
                            <td><?php echo _("Date of birth"); ?></td>
                            <td><input type="date" name="user-dob" id="user-dob" role="textbox" aria-multiline="false" class="w3-input w3-border w3-margin-bottom" value="<?php echo $u_dob; ?>" title="<?php echo _('Your date of birth.'); ?>" tabindex="4"></td>
                        </tr>
                        <tr>
                            <td><?php echo _("Locale"); ?></td>
                            <td>
                                <select name="user-l10n" id="user-l10n" class="w3-input w3-border w3-margin-bottom" title="<?php echo _('Your preferred locale.'); ?>" tabindex="5">
<?php
...
?>
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="user-loc" id="user-loc" class="w3-input w3-border w3-margin-bottom" title="<?php echo _('Some themes may display your location.'); ?>" tabindex="6">
<?php
...
?>
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="user-tzone" id="user-tzone" class="w3-input w3-border w3-margin-bottom" title="<?php echo _('Some themes may display your time zone.'); ?>" tabindex="7">
<?php
...
?>
                        ...
                        <tr>
                            ...
                            <td><textarea name="user-bio" id="user-bio" role="textbox" aria-multiline="true" class="w3-input w3-border w3-margin-bottom" title="<?php echo _('A short bio or description.'); ?>" tabindex="8"><?php echo $u_bio; ?></textarea></td>
                        </tr>

                    </table>
                    <input type="submit" name="profsubmit" id="profsubmit" role="button" class="w3-button w3-button-hover w3-theme-d3 w3-margin-left" value="<?php echo _('Update profile'); ?>" tabindex="9">
                </form>
