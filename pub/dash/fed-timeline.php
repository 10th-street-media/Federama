<?php
/*
 * pub/dash/fed-timeline.php
 *
 * A page with all public messages sent to the inboxes of users on this instance..
 *
...
$pagetitle = _("Federated timeline « $u_name « Ꞙederama");
include "header.php";
include "nav.php";
?>
			...
			<article class="w3-padding w3-col s12 m8 l10">
				...
				<h2 class="w3-padding"><?php echo _("Federated timeline"); ?></h2>
 ...
 */
 ...
 echo "\t\t\t\t<p>The <b>federated timeline</b> will contain all public messages created by all public accounts followed by users of this instance. Those public messages may originate from users on other instances.</p>\n";
 echo "\t\t\t\t</section>\n";
