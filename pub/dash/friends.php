<?php
/*
 * pub/dash/friends.php
 *
 * A page that lists an account's friends.
 * Friends are accounts that follow each other.
 *
...
$pagetitle = _("Friends « $u_name « Ꞙederama");
include "header.php";
include "nav.php";
?>
			...
			<article class="w3-padding w3-col s12 m8 l10">
				...
				<h2 class="w3-padding"><?php echo _("Friends"); ?></h2>
